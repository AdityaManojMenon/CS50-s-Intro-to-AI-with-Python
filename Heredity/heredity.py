...
def joint_probability(people, one_gene, two_genes, have_trait):
    ...
    for person in people:
        ...
        if people[person]["mother"] is None and people[person]["father"] is None:
            ...
            pass_probs = {parent: 0 for parent in [mother,father]}
            for parent in pass_probs:
            ...
            if genes == 2:
                ...
                gene_prob = pass_probs[mother] * (1 - pass_probs[father]) + (1 - pass_probs[mother]) * pass_probs[father]
            else:
